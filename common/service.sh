...
apply_settings() {
  ...
  echo -20 > /dev/stune/audio-app/schedtune.boost
...
echo "10" > /proc/sys/vm/swap_ratio
...
su -lp 2000 -c "cmd notification post -S bigtext -t 'DragonBoost_Optimized_For_SDM6XX' 'Tag' 'DragonBoost_Optimized_For_SDM6XX Successfully Installed, Have Fun Boost Your Android 6XX Devices!!!'" > /dev/null 2>&1
